%define distversion %( perl -e 'Creating /home/rst/code/korrent-0.1/korrent.spec...=\<\>;/(\d+)\.(\d)\.?(\d)?/; print "".(||0)' /etc/*-release)
Name: korrent
Summary: Korrent -- Some description
Version: 0.1
Release: %{_vendor}_%{distversion}
Copyright: GPL
Group: X11/KDE/Utilities
Source: ftp://ftp.kde.org/pub/kde/unstable/apps/utils/%{name}-%{version}.tar.gz
Packager: Roberto Teixeira <roberto@kde.org>
